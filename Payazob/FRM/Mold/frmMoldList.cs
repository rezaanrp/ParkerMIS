...
namespace Payazob.FRM.Mold
{
    public partial class frmMoldList : Form
    {
        ...
        DAL.Mold.DataSet_Mold.mMoldRepairRecordsDataTable dt_R;
        ...
        void generate()
        {
            ...
            //this.dataGridView2.Columns["xInitialCost"].DefaultCellStyle.FormatProvider = culture;
            this.dataGridView2.Columns["xInitialCost"].DefaultCellStyle.Format = "N0";


        }
        void generateRepairRecords()
        {
            CS.csDic css = new CS.csDic();
            ...
            dataGridView3.Columns["xMoldList_"].Visible = false;
            dataGridView3.Columns["xComment"].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            this.dataGridView3.Columns["xCost"].DefaultCellStyle.Format = "N0";
        }
        ...
        void ShowDataRepairRecords(int x_)
        {
            dt_R = new BLL.Mold.csMold().mMoldRepairRecords(x_);
            bindingSource3.DataSource = dt_R;
            dataGridView3.DataSource = bindingSource3;
            bindingNavigator3.BindingSource = bindingSource3;

            dataGridView3.Columns["x_"].Visible = false;
            dt_R.xMoldList_Column.DefaultValue = x_;
            dt_R.xSupplier_Column.DefaultValue = BLL.authentication.x_;
            dt_R.xDateColumn.DefaultValue = BLL.csshamsidate.shamsidate;

            generateRepairRecords();
        ...
        private void dataGridView2_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex > -1 && e.RowIndex > -1)
            {
                ShowDataRepairRecords((int)dataGridView2["x_", e.RowIndex].Value);
            }
        }
        ...
        private void toolStripButton18_Click(object sender, EventArgs e)
        {
            ...
            dataGridView2.EndEdit();
            if (new CS.csMessage().ShowMessageSaveYesNo())
                MessageBox.Show(new BLL.Mold.csMold().UdMoldRepairRecords(dt_R), "", MessageBoxButtons.OK, MessageBoxIcon.Information);
