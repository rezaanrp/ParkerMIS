...
namespace Payazob.FRM.Procurment
{
    public partial class frmProcurmentScarbTest : Form
    {
        ...
        bool Dtable(string Cl,string Ty)
        {
            ...
            dt_AC.Rows.Add("xMaterialNameInBill", "QC", false);
            dt_AC.Rows.Add("xBillSourceDate", "QC", false);
            dt_AC.Rows.Add("xBillNumber", "QC", false);
            ...
            dt_AC.Rows.Add("xMaterialNameInBill", "PR", true);
            dt_AC.Rows.Add("xBillSourceDate", "PR", true);
            dt_AC.Rows.Add("xBillNumber", "PR", true);
            ...
            dt_AC.Rows.Add("xMaterialNameInBill", "FN", false);
            dt_AC.Rows.Add("xBillSourceDate", "FN", false);
            dt_AC.Rows.Add("xBillNumber", "FN", false);
            ...
            dt_AC.Rows.Add("xMaterialNameInBill", "TR", false);
            dt_AC.Rows.Add("xBillSourceDate", "TR", false);
            dt_AC.Rows.Add("xBillNumber", "TR", false);
        ...
        void Generate()
        {
            ...
            dataGridView1.Columns["cmb_Material"].DisplayIndex = dataGridView1.Columns["xMaterial_"].DisplayIndex;
        ...
        private void saveToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow item in dataGridView1.Rows)
            {
                if ((item.Cells["xWeightBeginning"].Value.ToString() == "" || item.Cells["xWeightDestination"].Value.ToString() == "") &&
                    item.Cells["xDriverName"].Value.ToString() == "" && item.Cells["xCarNumber"].Value == DBNull.Value && item.Cells["xCarNumber"].Value.ToString() == "")
                {
        ...
        private void dataGridView1_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            ...
            if (dataGridView1.Columns[e.ColumnIndex].Name == "xCarNumber")
            {
                if (e.FormattedValue.ToString().Contains("_"))
                { // flag = v.ValidationDate(e.FormattedValue.ToString());
                    /// if (flag) flag = cs.CompareDate(e.FormattedValue.ToString(), dataGridView1["xDateEnter", e.RowIndex].Value.ToString());
                    /// 
                     }
                   if( e.FormattedValue.ToString().Split(' ').Length == 4  
                        && e.FormattedValue.ToString().Split(' ')[0] != ""
                        && e.FormattedValue.ToString().Split(' ')[0].Length == 2
                        && e.FormattedValue.ToString().Split(' ')[1] != ""
                        && e.FormattedValue.ToString().Split(' ')[1].Length == 3
                        && e.FormattedValue.ToString().Split(' ')[2] != ""
                        && e.FormattedValue.ToString().Split(' ')[2].Length == 1
                        && e.FormattedValue.ToString().Split(' ')[3] != ""
                        && e.FormattedValue.ToString().Split(' ')[3].Length == 2
                        )
                e.Cancel = false;
                else
                    e.Cancel = true;
