...
namespace Payazob.FRM.Procurment
{
    public partial class frmProcurmentMaterialTest : Form
    {
        ...
        bool Dtable(string Cl, string Ty)
        {
            ...
            dt_AC.Rows.Add("xPLConfirm", "QC", false);
            dt_AC.Rows.Add("xPLApprove", "QC", false);
            //,
            ...
            dt_AC.Rows.Add("xPLConfirm", "FN", false);
            dt_AC.Rows.Add("xPLApprove", "FN", false);
            ...
            dt_AC.Rows.Add("xPLConfirm", "PR", false);
            dt_AC.Rows.Add("xPLApprove", "PR", false);
            ...
            dt_AC.Rows.Add("xPLConfirm", "TR", false);
            dt_AC.Rows.Add("xPLApprove", "TR", false);


            dt_AC.Rows.Add("x_", "LS", false);
            dt_AC.Rows.Add("xDateTest", "LS", true);
            dt_AC.Rows.Add("xDriverName", "LS", true);
            dt_AC.Rows.Add("xDriverTel", "LS", true);
            dt_AC.Rows.Add("xWeightBeginning", "LS", true);
            dt_AC.Rows.Add("xWeightDestination", "LS", true);
            dt_AC.Rows.Add("xRegion_", "LS", true);
            dt_AC.Rows.Add("xCity", "LS", true);
            dt_AC.Rows.Add("xRent", "LS", true);
            dt_AC.Rows.Add("xUsage", "LS", true);
            dt_AC.Rows.Add("xUsageMeltingAmount", "LS", true);
            dt_AC.Rows.Add("xAbsorptionPercent", "LS", true);
            dt_AC.Rows.Add("xState", "LS", true);
            dt_AC.Rows.Add("xConfirm", "LS", false);
            dt_AC.Rows.Add("xApprove", "LS", false);
            dt_AC.Rows.Add("cmb_State", "LS", true);
            dt_AC.Rows.Add("xTRConfirm", "LS", false);
            dt_AC.Rows.Add("xTRApprove", "LS", true);
            dt_AC.Rows.Add("xCarNumber", "LS", true);
            dt_AC.Rows.Add("xEntranceNumber", "LS", true);
            dt_AC.Rows.Add("xRequestingItem", "LS", true);
            dt_AC.Rows.Add("xTestResults", "LS", true);
            dt_AC.Rows.Add("xQCComment", "LS", true);
            dt_AC.Rows.Add("xPLConfirm", "LS", true);
            dt_AC.Rows.Add("xPLApprove", "LS", true);
        ...
        void Generate()
        {
            ...
            if (Se == "TR")
            {
                ...
                dataGridView1.Columns["xTRConfirm"].DefaultCellStyle.BackColor = Color.LawnGreen;
            ...
            if (Se == "QC")
            {
              ...
              //  dataGridView1.Columns["xConfirm"].DefaultCellStyle.BackColor = Color.LawnGreen;
            ...
            if (Se == "LS")
            {
                ...
                dataGridView1.Columns["xPLConfirm"].ReadOnly = false;
                dataGridView1.Columns["cmb_State"].Visible = false;
                dataGridView1.Columns["xSupplierCompany_"].Visible = false;
                dataGridView1.Columns["xPLConfirm"].DefaultCellStyle.BackColor = Color.LawnGreen;
            ...
            dt_P.xPLConfirmColumn.DefaultValue = false;
            dt_P.xConfirmColumn.DefaultValue = false;
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
          ...
          else  if (e.RowIndex > -1 && e.ColumnIndex == dataGridView1.Columns["xTRConfirm"].Index)
          ...
          else  if (e.RowIndex > -1 && e.ColumnIndex == dataGridView1.Columns["xPLConfirm"].Index)
                if ((bool)dataGridView1["xPLConfirm", e.RowIndex].Value == true)
                {
                    dataGridView1["xPLApprove", e.RowIndex].Value = BLL.authentication.NameAndFamily;
                }
                else
                    dataGridView1["xPLApprove", e.RowIndex].Value = "";

            //xPLConfirm,xPLApprove
        ...
        private void printToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else if (Se == "PL")
            {
                ...
                {
                    BLL.Procurement.csProcurmentMaterialTest css = new BLL.Procurement.csProcurmentMaterialTest();
                    DataTable dt = css.SlProcurmentMaterialTestReport_ForTag((int)dataGridView1.SelectedRows[0].Cells["x_"].Value);
                    Report.SendReport cs = new Report.SendReport();
                    frmReport r = new frmReport();
                    r.GetReport = cs.GetReport(dt, "crsProcurmentMaterialTestPL");
                    r.ShowDialog();
                    r.Dispose();
                }
            }
