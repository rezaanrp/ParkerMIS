...
namespace MIS
{
    ...
    {
        public frmMoldingDownTime(bool editable)
        {
            ...
            DataGridViewComboBoxColumn column2 = new DataGridViewComboBoxColumn
            {
                ...
                DataSource = new BLL.Machine.csMachine().mMachine(1, 1),
            ...
            //if (this.fct != MIS.CS.csEnum.Factory.Site3)
            //{
            ...
            DataGridViewComboBoxColumn column3 = new DataGridViewComboBoxColumn
            {
                DisplayIndex = 0,
                HeaderText = "نوع توقف",
                DataSource = time.SelectMoldingDownTimeType(false),
            ...
            this.frmO = new frmMoldingDownTimeType(true, MIS.CS.csEnum.TypeTree.DownTimeObject);
            this.frmT = new frmMoldingDownTimeType(true, MIS.CS.csEnum.TypeTree.DownTimeType);
        ...
        {                
            ...
            if (js == JShift.Both)
            {
                ...
                dt_I = cs.SelectMoldingDownTime(uc_Filter_Date1.DateFrom, uc_Filter_Date1.DateTo);
        ...
        private void dataGridView_D_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (this.frmT.IsUpdate)
            {
                ...
                (this.dataGridView_D.Columns["DownTimeType"] as DataGridViewComboBoxColumn).DataSource = time.SelectMoldingDownTimeType(true);
        ...
        private void dataGridView1_CellBeginEdit(object sender, DataGridViewCellCancelEventArgs e)
        {
            ...
            {
                MIS.FRM.frmDate.frmDate date = new MIS.FRM.frmDate.frmDate
                {
        ...
        private void printToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = new BLL.MoldingDownTime.MoldingDownTime().SlMoldingDownTimeByDetial(uc_Filter_Date1.DateFrom,uc_Filter_Date1.DateTo);
