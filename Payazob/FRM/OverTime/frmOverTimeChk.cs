    ...
    public partial class frmOverTimeChk : Form
    {
       ...
       void ShowData1()
       {
          ...
          //  dataGridView1.Columns["xName"].HeaderText = " نام ";
           dataGridView1.Columns["PerName"].HeaderText = " نام و نام خانوادگی";
            dataGridView1.Columns["PerName"].Width =300;
            dataGridView1.Columns["xSection"].Width =150;
            dataGridView1.Columns["xPerID"].HeaderText = "شماره پرسنلی";
            dataGridView1.Columns["xSection"].HeaderText = "قسمت";
       ...
       DAL.Person.DataSet_PersonIO.sp_PAYAReportDataTable dt_A;
       ...
       private void dataGridView1_CellEnter(object sender, DataGridViewCellEventArgs e)
       {
            if (dataGridView1["xPerID", e.RowIndex].Value != null && dataGridView1["xPerID", e.RowIndex].Value != DBNull.Value)
            {
                ...
                string st2 = dataGridView1["xPerID", e.RowIndex].Value.ToString();
                if (System.Text.RegularExpressions.Regex.IsMatch(st2, "^[0-9]+$"))
                {

                    dt_A = cs.OverTimeIO(double.Parse(dataGridView1["xPerID", e.RowIndex].Value.ToString()),
                    ...
                    this.dataGridView_IO.Columns["EMP_NO"].HeaderText = "شماره کارت ";
                    this.dataGridView_IO.Columns["PERS_NO"].HeaderText = "شماره پرسنلی";
                    this.dataGridView_IO.Columns["NAME"].HeaderText = "نام ";
                    this.dataGridView_IO.Columns["FAMILY"].HeaderText = "نام خانوادگی";
                    this.dataGridView_IO.Columns["Date_"].HeaderText = " تاریخ ";
                    this.dataGridView_IO.Columns["Time_"].HeaderText = "ساعت ";



                    this.dataGridView_IO.Columns["EMP_NO"].Visible = false;
                    this.dataGridView_IO.Columns["NAME"].Visible = false;
                    this.dataGridView_IO.Columns["FAMILY"].Visible = false;
                    this.dataGridView_IO.Columns["PERS_NO"].Visible = false;
                }
                ///////////////////////////////////////////////////////////////////////////////
