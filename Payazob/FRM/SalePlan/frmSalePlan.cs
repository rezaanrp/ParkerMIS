...
namespace Payazob.FRM.SalePlan
{
    public partial class frmSalePlan : Form
    {
        ...
        bool Dtable(string Cl, string Ty)
        {
            ...
            dt_AC.Rows.Add("xEnterTime", "SC", true);
            dt_AC.Rows.Add("xExitTime", "SC", true);
        ...
        void Generate()
        {
            ...
            foreach (DataColumn dc in dt_S.Columns)
            {
                if (dataGridView1.Columns[dc.ColumnName] != null)
                {
                    ...
                    //  dataGridView1.Columns[dc.ColumnName].DisplayIndex = dt_S.Columns[dc.ColumnName].Ordinal;
            ...
            dataGridView1.Columns["xEnterTime"].DisplayIndex = dataGridView1.Columns["xCarNumber"].DisplayIndex;
            dataGridView1.Columns["xExitTime"].DisplayIndex = dataGridView1.Columns["xCarNumber"].DisplayIndex;
            ...
            else if (Se == "SC")
            {
                ...
                dataGridView1.Columns["xEnterTime"].ReadOnly = false;
                dataGridView1.Columns["xExitTime"].ReadOnly = false;
        ...
        private void dataGridView1_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (dataGridView1.Columns[e.ColumnIndex].Name == "xPieces")
            {
   
                    dataGridView1["xCount", e.RowIndex].Value = DBNull.Value;
        ...
        {
            if (
               dataGridView1.Columns[e.ColumnIndex].Name == "xCount" 
               &&
                dataGridView1.Columns[e.ColumnIndex].ReadOnly == false
               )
            {
                if (dataGridView1["xPieces_", e.RowIndex].Value == DBNull.Value)
                {
                ...
                else
                {
                    ...
                    int iv1;
                    int.TryParse(dataGridView1["xCount", e.RowIndex].EditedFormattedValue.ToString(), out iv1);
                    int cinv = new BLL.csInventory().fnStockPiecesCheck(Payazob.Properties.Settings.Default.WorkYear, iv);
                    if (dataGridView1["xCount", e.RowIndex].EditedFormattedValue.ToString() == "" || iv1 == 0)
                    {
                        e.Cancel = false;
