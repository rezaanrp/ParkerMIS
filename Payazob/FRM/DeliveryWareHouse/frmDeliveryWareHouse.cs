...
namespace Payazob.FRM.DeliveryWareHouse
{
    public partial class frmDeliveryWareHouse : Form
    {
        ...
        void Generate()
        {
            ...
            dataGridView1.Columns["xDate"].DefaultCellStyle.BackColor = Color.Honeydew;
            dataGridView1.Columns["xDateDelivery"].DefaultCellStyle.BackColor = Color.Honeydew;
            dataGridView1.Columns["DateRead"].DefaultCellStyle.BackColor = Color.Honeydew;
