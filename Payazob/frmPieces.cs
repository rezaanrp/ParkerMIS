...
namespace Payazob
{
    public partial class frmPieces : Form
    {
        ...
        private void GenerateMachining()
        {
            ...
            this.dataGridView1.Columns["xName"].HeaderText = "نام قطعه";
            this.dataGridView1.Columns["xName"].Width = 200;
            this.dataGridView1.Columns["xProductSpeed"].HeaderText = "تعداد تولید در دقیقه";
            ...
            this.dataGridView1.Columns["xSGCode"].Visible = true;
            this.dataGridView1.Columns["cmb_STU"].Visible = true;
            this.dataGridView1.Columns["xProductSpeed"].Visible = true;
