...
namespace Payazob.MyControl.Chart
{
    public partial class uc_ChartInvCollect : UserControl
    {
        ...
        void SlInventoryForManager()
        {
           ...
           dt_SlInventoryForManager = cs.SlInventoryForManager(Payazob.Properties.Settings.Default.WorkYear);
        ...
        void SlStockPiecesGrp()
        {
            ...
            BLL.ManagerReport.csManagerReport cs = new BLL.ManagerReport.csManagerReport();
            dt_SlStockPiecesGrp = cs.SlStockPiecesGrp(Payazob.Properties.Settings.Default.WorkYear);
            // MessageBox.Show("Finish");
        ...
        {
            BLL.ManagerReport.csManagerReport cs = new BLL.ManagerReport.csManagerReport();
             dt_SlInventoryAllMaterial = cs.SlInventoryAllMaterial(Payazob.Properties.Settings.Default.WorkYear);
            // MessageBox.Show("Finish");
        ...
        void ChartGenerate_5()
        {
           ...
           // chart5.ChartAreas["ChartArea1"].AxisY2.Minimum = 2D;
            ...
            if (chart5_switch == 1)
            {
                ...
                DataTable dt = cs.SlPruductPiecesByMonth(Payazob.Properties.Settings.Default.WorkYear);
                progressBar_TL.Visible = false;
            ...
            else if (chart5_switch == 2)
            {
                ...
                DataTable dt = cs.SlMoldingDownTimeSumNodeByMonth(Payazob.Properties.Settings.Default.WorkYear, tree_id,(int)CS.csEnum.Factory.Site1);
                progressBar_TL.Visible = false;
        ...
        void ChartGenerate_BL()
        {
           ...
           // chart_BL.ChartAreas["ChartArea1"].AxisY2.Minimum = 2D;
            ...
            if (chart_BL_switch == 1)
            {
                ...
                BLL.ManagerReport.csManagerReport cs = new BLL.ManagerReport.csManagerReport();
                DataTable dt = cs.SlMeltWeightByMonth(Payazob.Properties.Settings.Default.WorkYear);
