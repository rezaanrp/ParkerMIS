...
namespace Payazob
{
    public partial class frmLogin : Form
    {
        ...
        private void panel1_Paint(object sender, PaintEventArgs e)
        {
          ...
          //  LinearGradientBrush brush0 = new LinearGradientBrush(new Rectangle(0, 0, 500, 250), Color.FromArgb(255, 100, 0), Color.FromArgb(0, 0, 0), 90.0f);
            
          //  e.Graphics.FillRectangle(brush0, 0, 10, 1500, 1600);
