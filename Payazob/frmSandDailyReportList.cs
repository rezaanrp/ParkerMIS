...
namespace Payazob
{
    ...
    {
        public frmSandDailyReportList(bool ReadOnlyMyForm)
        {
            InitializeComponent();
        ...
        void ReadOnlyForm()
        {
            ...
            dataGridView_D_A.ReadOnly = true;
            dataGridView_D_B.ReadOnly = true;
            bindingNavigator_D_A.Enabled = false;
            bindingNavigator_D_B.Enabled = false;
            ChLine1.Enabled = false;
            ChLine2.Enabled = false;
            CHLine3.Enabled = false;
        ...
        private void generateForm_D_A()
        {
           // int xBantonit, int xSandNew, int xCoalDust, int xWater, int xBatchCount, int xSandReturn, int xOther, string xOtherName, int xSandDailyReport_
            ...
            dataGridView_D_A.Columns["xBantonitPainBasedOnMoldWeight"].HeaderText = "بنتونبت درصد بر اساس وزن قالب";
            dataGridView_D_A.Columns["xBantonitFormulaNumber"].HeaderText = "بنتونیت عدد فرمول";
            dataGridView_D_A.Columns["xBantonitRealNumber"].HeaderText = "بنتونیت عدد واقعی";
            dataGridView_D_A.Columns["xSandNewPainBasedOnMoldWeight"].HeaderText = "ماسه نودرصدبراساس وزن قالب";
            dataGridView_D_A.Columns["xSandNewFormulaNumber"].HeaderText = "ماسه نوعددفرمول";
            dataGridView_D_A.Columns["xSandNewRealNumber"].HeaderText = "ماسه نوعددواقعی";
            dataGridView_D_A.Columns["xCoalDustPainBasedOnMoldWeight"].HeaderText = "پودرزغال درصد براساس وزن قالب";
            dataGridView_D_A.Columns["xCoalDustFormulaNumber"].HeaderText = "پودرزغال عدد فرمول";
            dataGridView_D_A.Columns["xCoalDustRealNumber"].HeaderText = "پودرزغال عددواقعی";
        ...
        private void generateForm_D_B()
        {
            ...
            dataGridView_D_B.Columns["xLossOfIgnition"].HeaderText = "Loss Of Ignition";
            dataGridView_D_B.Columns["xVolatileMaterial"].HeaderText = "Volatile Material";
            dataGridView_D_B.Columns["xReturnedSandTemperature"].HeaderText = "دمای ماسه برگشتی";
            dataGridView_D_B.Columns["xReturnedSandMoisture"].HeaderText = "رطوبت ماسه برگشتی";
            dataGridView_D_B.Columns["xCollapseStrength"].HeaderText = "استحکام فروپاشی";
            dataGridView_D_B.Columns["xDensityToMoistureRatio"].HeaderText = "نسبت تراکم به رطوبت";
            dataGridView_D_B.Columns["xMixTime"].HeaderText = "زمان میکس";
            dataGridView_D_B.Columns["xMixerWeight"].HeaderText = "وزن میکسر";
            dataGridView_D_B.Columns["xAmountOfWater"].HeaderText = "میزان آب کیلوگرم";
