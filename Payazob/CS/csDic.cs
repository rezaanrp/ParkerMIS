...
namespace Payazob.CS
{
   ...
   new Dictionary<string, string>();
            ...
            dictionary.Add("xDefectList_", "عیوب  ");
            dictionary.Add("xGenLine_", "نام ایستگاه تولید  ");

            dictionary.Add("xCountMold", "تعداد قالب");

            dictionary.Add("xIngotQty", "تعداد شافت");


            dictionary.Add("xMaterialNameInBill", " نام مواد در بارنامه ");
            dictionary.Add("xBillSourceDate", " تاریخ بارنامه ");
            dictionary.Add("xBillNumber", " شماره بارنامه ");
            //
            dictionary.Add("xEnterTime", " ساعت ورود ");
            dictionary.Add("xExitTime", " ساعت خروج ");


            dictionary.Add("SgdbCode", " کد همکاران سیستم ");
            dictionary.Add("xSgCode", " کد همکاران سیستم ");
            
            dictionary.Add("MojodiAnbarRikhtegari", " موجودی انبار ریخته گری ");
            dictionary.Add("MojodiMahsolMashinKari", " موجودی محصول ماشین کاری");
            dictionary.Add("MojodiMavadKhamMashinkari", " موجودی مواد خام ماشینکاری ");
            dictionary.Add("MojodiMahsolDarjaryanS3", " موجودی محصول در جریان ماشینکاری ");
            dictionary.Add("MojodiMahsolDarjaryanS1", " موجودی محصول در جریان ریخته گری ");
            
            dictionary.Add("xGoodsDescription", "مشخصات کالا");
            dictionary.Add("xUsageFor", "محل  مصرف");
            dictionary.Add("xUnits", " واحد ");
            //
            dictionary.Add("xHSEWarning", " اخطار ایمنی ");
            dictionary.Add("xGenHSEWarningType_", " نوع اخطار ایمنی ");

            dictionary.Add("SendPiecesToProduct", " برگشت به تولید ");

            dictionary.Add("xInitialCost", " هزینه اولیه - ریال");

            dictionary.Add("xCost", "هزینه - ریال");
            dictionary.Add("xCompany", " شرکت ");

            dictionary.Add("xGenSTMACHINE_", " وضعیت دستگاه ");

            dictionary.Add("xAvailableTime", " زمان در دسترس ");


            dictionary.Add("xPLConfirm", " تایید واحد لجستیک ");
            dictionary.Add("xPLApprove", " کاربر واحد لجستیک ");

            dictionary.Add("xGenLINENAME3_", " نام ایستگاه کاری ");

            dictionary.Add("xProductSpeed", " تعداد تولید در ساعت ");


            dictionary.Add("xDatePlan", "تاریخ");
            dictionary.Add("xShift_Plan", "شیفت در برنامه");
            dictionary.Add("xPieces_Plan", "نام قطعه برنامه");
            dictionary.Add("xDateProduct", "تاریخ تولید");
            dictionary.Add("xShift_Product", "شیفت تولید");
            dictionary.Add("xPieces_Product", "نام قطعه تولید شده");
            dictionary.Add("xCountProduct", "تعداد تولید");
            dictionary.Add("PercentageOfRealization", "درصد تحقق");

            dictionary.Add("CountDelivery", "تعداد دریافتی");

            dictionary.Add("xShoeSize", "سایز کفش");
            dictionary.Add("xDressSize", "سایز لباس");
            dictionary.Add("FoundryType", " نوع ذوب");

            dictionary.Add("xSex_", " جنسیت ");
            dictionary.Add("xCompany_", " نام شرکت ");
            dictionary.Add("xGenExitType_", " نوع خروج ");

            dictionary.Add("xSupplierDate", " تاریخ ثبت ");
            dictionary.Add("xSupplierTime", " ساعت ثبت ");
            dictionary.Add("xManagerComment", " توضیحات مدیر واحد ");

            dictionary.Add("xReturnAmount", "مقدار برگشت شده ");

            dictionary.Add("xWeekDay", " روز هفته  ");
            dictionary.Add("xProductSpeedCount", " سرعت تولید ");
