...
namespace Payazob
{
    public partial class Main : Form
    {
        ...
        void CheakWorkYear()
        {
            if (Payazob.Properties.Settings.Default.WorkYear.Substring(0, 4) != BLL.csshamsidate.shamsidate.Substring(0, 4))
            {
                MessageBox.Show("سال کاری  " + " " + Payazob.Properties.Settings.Default.WorkYear.Substring(0, 4) + " " + "تنظیم شده ");
            }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
            //string[] Ary_order = Payazob.Properties.Settings.Default.TreeviewOrder.Split('#');
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void treeView1_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            if (int.Parse(e.Node.Tag.ToString()) > 0)
            {
                ...
                Payazob.Properties.Settings.Default.TreeviewOrder = tt;
                Payazob.Properties.Settings.Default.Save();
        ...
        {
            lbl_DateNow.Text = new BLL.csshamsidate().shamsidatAndDayOFWeek() + "    " + BLL.authentication.NameAndFamily;
