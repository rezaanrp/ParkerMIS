...
namespace Payazob
{
    public partial class frmFoundryMaterialUsage_Report : Form
    {
        ...
        void Generate()
        {
            ...
            dataGridView1.Columns["Furnace5"].HeaderText = "کوره پنج";
            dataGridView1.Columns["Total"].HeaderText = "مجموع";
            dataGridView1.Columns["Total"].DefaultCellStyle.BackColor = System.Drawing.Color.AliceBlue;
            dataGridView1.Columns["xMaterialName"].DefaultCellStyle.BackColor = System.Drawing.Color.Aquamarine;
        }
