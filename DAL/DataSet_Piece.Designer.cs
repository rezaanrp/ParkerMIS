    ...
    public partial class DataSet_Piece : global::System.Data.DataSet {
        ...
        public partial class SelectPiecesByNameRow : global::System.Data.DataRow {
            ...
            public int xProductSpeed {
                get {
                    try {
                        return ((int)(this[this.tableSelectPiecesByName.xProductSpeedColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'xProductSpeed\' in table \'SelectPiecesByName\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableSelectPiecesByName.xProductSpeedColumn] = value;
                }
            }
            ...
            public bool IsxProductSpeedNull() {
                return this.IsNull(this.tableSelectPiecesByName.xProductSpeedColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetxProductSpeedNull() {
                this[this.tableSelectPiecesByName.xProductSpeedColumn] = global::System.Convert.DBNull;
            }
...
FROM            mPieces
WHERE        (xGenGroupByFactory_ = @xGenGroupByFactory_) AND (xGenStatus_ <> 20)
ORDER BY xName";
...
SELECT xMuscleName, xMachine_, xMuscleTimeToProduct, xMusclePay, x_, xSGCode, xName FROM mPieces WHERE (x_ = @x_)";
    ...
    public partial class SelectPiecesByNameTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@xProductSpeed", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 10, 0, "xProductSpeed", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@xProductSpeed", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 10, 0, "xProductSpeed", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Insert(
                    ...
                    global::System.Nullable<int> xProductSpeed) {
            if ((xName == null)) {
                this.Adapter.InsertCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
            else {
            ...
            if ((xProductSpeed.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[30].Value = ((int)(xProductSpeed.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((xProductSpeed.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[30].Value = ((int)(xProductSpeed.Value));
            }
            else {
