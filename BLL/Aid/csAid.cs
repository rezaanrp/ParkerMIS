...
namespace BLL.Aid
{
    public class csAid
    {
        ...
        public DataTable SlSectionAidDeliveryTotalByDate(string DateFrom, string DateTo)
        {
            return new BLL.Connection.csConnection().SqlDataTabeReturn("SlSectionAidDeliveryTotalByDate"
                , "@DateFrom", DateFrom
                , "@DateTo", DateTo
                );
        ...
        public DAL.Aid.DataSet_Aid.SlSectionAidDeliveryNewDataTable mSectionAidDelivery(string DateFrom, string DateTo, int? xPerson_)
        {
            DAL.Aid.DataSet_AidTableAdapters.SlSectionAidDeliveryNewTableAdapter adp =
                 new DAL.Aid.DataSet_AidTableAdapters.SlSectionAidDeliveryNewTableAdapter();
            return adp.GetData(DateFrom, DateTo, xPerson_);
        }

        public string UdSectionAidDelivery(DAL.Aid.DataSet_Aid.SlSectionAidDeliveryNewDataTable dt)
        {
            try
            {
                DAL.Aid.DataSet_AidTableAdapters.SlSectionAidDeliveryNewTableAdapter adp =
