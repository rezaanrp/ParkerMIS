...
namespace BLL
{
    public class csDefect
    {
        ...
        public DAL.QualityControl.DataSet_PruductInspection.SlProductInspectionDetails_Date_RDataTable SlProductInspectionDetails_Date_R(string DateFrom, string DateTo)
        {
            DAL.QualityControl.DataSet_PruductInspectionTableAdapters.SlProductInspectionDetails_Date_RTableAdapter adp =
                new DAL.QualityControl.DataSet_PruductInspectionTableAdapters.SlProductInspectionDetails_Date_RTableAdapter();
       ...
       {
           DAL.DataSet_DefectTableAdapters.mDefectListTableAdapter 
                adp = new DAL.DataSet_DefectTableAdapters.mDefectListTableAdapter();
           return adp.GetData();
       }
