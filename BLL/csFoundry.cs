...
namespace BLL
{
    public class csFoundry
    {
        ...
        public DataTable SlFoundryMaterialUsageByDay_Report(string DateFrom, string DateTo)
        {
            return new Connection.csConnection().SqlDataTabeReturn("SlFoundryMaterialUsageByDay_Report", "@DateFrom", DateFrom, "@DateTo", DateTo);
        }
