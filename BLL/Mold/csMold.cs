   ...
   public class csMold
    {
        ...
        public DAL.Mold.DataSet_Mold.mMoldRepairRecordsDataTable mMoldRepairRecords(int xMoldList_)
        {
            DAL.Mold.DataSet_MoldTableAdapters.mMoldRepairRecordsTableAdapter adp =
                new DAL.Mold.DataSet_MoldTableAdapters.mMoldRepairRecordsTableAdapter();
            return adp.GetData(xMoldList_);
        }

        public string UdMoldRepairRecords(DAL.Mold.DataSet_Mold.mMoldRepairRecordsDataTable dt)
        {
