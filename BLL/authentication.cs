...
namespace BLL
{
    public class authentication
    {
        ...
        public DAL.DataSet_Authentication.SlObjectAllowByUser_DataTable SlObjectAllowByUser_(int xUser_)
        {
            DAL.DataSet_AuthenticationTableAdapters.SlObjectAllowByUser_TableAdapter adp
                 = new DAL.DataSet_AuthenticationTableAdapters.SlObjectAllowByUser_TableAdapter();
            return adp.GetData(xUser_);
        }
        public string UdObjectAllowByUser_(DAL.DataSet_Authentication.SlObjectAllowByUser_DataTable dt)
        {
            try
            {
                DAL.DataSet_AuthenticationTableAdapters.SlObjectAllowByUser_TableAdapter adp
