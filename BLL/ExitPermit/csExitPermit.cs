...
namespace BLL.ExitPermit
{
    ...
    {
        public DAL.ExitPermit.DataSet_ExitPermit.SlExitPermitForPrintDataTable SlExitPermitForPrint(int x_)
        {
            DAL.ExitPermit.DataSet_ExitPermitTableAdapters.SlExitPermitForPrintTableAdapter adp =
                new DAL.ExitPermit.DataSet_ExitPermitTableAdapters.SlExitPermitForPrintTableAdapter();
