...
namespace BLL.PerFoodStatus
{
    ...
    {
        public DataTable SlPerFoodToken()
        {
            DAL.Food.DataSet_PerFoodTokenTableAdapters.SlPerFoodTokenTableAdapter adp =
                new DAL.Food.DataSet_PerFoodTokenTableAdapters.SlPerFoodTokenTableAdapter();
            return adp.GetData();
        }
