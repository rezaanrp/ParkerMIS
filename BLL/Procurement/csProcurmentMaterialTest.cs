...
namespace BLL.Procurement
{
    public class csProcurmentMaterialTest
    {
        ...
        public DAL.Procurement.DataSet_ProcurmentMaterialTest.SlProcurmentMaterialTestReport_ForTagDataTable SlProcurmentMaterialTestReport_ForTag(int x_)
        {
            DAL.Procurement.DataSet_ProcurmentMaterialTestTableAdapters.SlProcurmentMaterialTestReport_ForTagTableAdapter adp =
                 new DAL.Procurement.DataSet_ProcurmentMaterialTestTableAdapters.SlProcurmentMaterialTestReport_ForTagTableAdapter();
